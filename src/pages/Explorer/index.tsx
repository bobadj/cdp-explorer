    ...
    <>
      <div className="bg-slate-200 pb-32 pt-20">
        <div className="max-w-[80%] mx-auto text-center">
          <h1 className="text-6xl mb-14 font-bold tracking-wide max-w-[70%] mx-auto">31,816 total MakerDAO vaults with ~1.1 billions in DAI</h1>
      ...
      <div className="container mx-auto mt-[-100px] pb-[50px]">
        <Select className="justify-end" label="Collateral Type:" />
        <Table />
      </div>
    </>
  )
